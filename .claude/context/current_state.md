...
Last updated: April 2026, post-CP11.3 patch (Initiative Locking, Early Exit, MAP).
...
Verified 42 times (most recently at CP11.3 patch — initiative locking, early exit, MAP).
